...
frame.setVisible(true);
       ...
       JPanel header= createHeader("school");
...
frame.add(quizPanel);
 ...
 firstButton =createButton("For 2000");
   // 7. Add the firstButton to the quizPanel
       ...
       secondButton =  createButton ("for 1000");
...
firstButton.addActionListener(this);
   ...
   private JButton createButton(String dollarAmount) {
       ...
       JButton button= new JButton("roberto");
...
playJeopardyTheme();
       ...
       if (arg0.getSource()==firstButton) {
           ...
           askQuestion("What is the first game to exist","pong",2000);
           firstButton.setText("");
...
askQuestion("what is the word","bird",2000);
...
secondButton.setText("");
   ...
   private void askQuestion(String question, String correctAnswer, int prizeMoney) {
      ...
      String won= JOptionPane.showInputDialog(null, question);
       // Use a pop up to ask the user the question
   
       // If the answer is correct
       if (won==correctAnswer) {
